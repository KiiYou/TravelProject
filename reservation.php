    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          ...
          <p>Book your spot today to secure the best experience. Limited availability, exclusive offers, and seamless booking make it easier than ever to reserve now!</p>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                  <fieldset>
                      ...
                      <input type="text" name="name" class="Name" placeholder="Ex. Hamdy Mohamed" autocomplete="on" >
                  </fieldset>
              </div>
              <div class="col-lg-6">
                <fieldset>
                    <label for="Number" class="form-label">Your Phone Number</label>
                    <input type="text" name="phone_number" class="Number" placeholder="Ex. +20 xxxxxxxxxx" autocomplete="on" >
                </fieldset>
              </div>
              <div class="col-lg-6">
                  <fieldset>
